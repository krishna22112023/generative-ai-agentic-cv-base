...
def create_ir_pipeline(prefix:str) -> str:
    ...
    logger.info(f"Loading Image Quality Assessment results from local path : {iqa_results_path}")
    ...
    logger.info("Determining which restoration models to run based on the Image Quality Assessment results.")
    pipeline = {}
    ...
    logger.info("Saving image restoration pipeline")
...
def run_ir_pipeline(prefix:str) -> bool:
    ...
    """
    logger.info("Running pipeline for image restoration ")
